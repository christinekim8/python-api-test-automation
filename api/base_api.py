...
class BaseAPI:
    ...
    def post(self, endpoint, data, params=None):
        ...
        response = requests.post(url, json=data, params=all_params, headers=self.headers)
        return response
    ...
    def get(self, endpoint, params=None):
        ...
        url = self._build_url(endpoint)
        all_params = self._with_auth_params(params)
        response = requests.get(url, params=all_params, headers=self.headers)
        return response
    ...
    def put(self, endpoint, data, params=None):
        ...
        url = self._build_url(endpoint)
        all_params = self._with_auth_params(params)
        response = requests.put(url, json=data, params=all_params, headers=self.headers)
        return response
    ...
    def delete(self, endpoint, params=None):
        ...
        url = self._build_url(endpoint)
        all_params = self._with_auth_params(params)
        response = requests.delete(url, params=all_params, headers=self.headers)
        return response